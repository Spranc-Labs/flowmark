...
export class Highlighter {
  ...
  async createHighlight(range: Range, color?: string): Promise<Highlight> {
    ...
    const highlight: Highlight = {
      ...
      prefix: '', // TODO: Extract from range
      suffix: '', // TODO: Extract from range
      color: highlightColor,
      createdAt: new Date(),
   ...
   */
  private handleHighlightClick(_highlightId: string, _event: MouseEvent): void {
    // Default behavior: could be used to show edit UI, etc.
  }
